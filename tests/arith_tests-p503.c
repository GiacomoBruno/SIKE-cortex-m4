...
{ // Tests for the field arithmetic
    ...
    print_test("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    print_test("Testing field arithmetic over GF(p503): \n\n"); 
    ...
    else { print_test("  GF(p) subtraction tests... FAILED"); printf("\n"); return false; }
    print_test("\n");
    ...
    else { print_test("  GF(p) multiplication tests... FAILED"); printf("\n"); return false; }
    print_test("\n");
...
{ // Tests for the quadratic extension field arithmetic
    ...
    print_test("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    print_test("Testing quadratic extension arithmetic over GF(p503^2): \n\n"); 
...
bool fp_run()
{
    ...
    print_test("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    print_test("Benchmarking field arithmetic over GF(p503): \n\n"); 
    ...
    print_bench("  GF(p) addition runs in .......................................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  GF(p) subtraction runs in ....................................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  GF(p) multiplication runs in .................................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  GF(p) reduction runs in ......................................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  GF(p) inversion (exponentiation) runs in ........................ %7lld ", cycles/SMALL_BENCH_LOOPS); print_unit;
    print_test("\n"); 
...
bool fp2_run()
{
    ...
    print_test("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    print_test("Benchmarking quadratic extension arithmetic over GF(p503^2): \n\n"); 
    ...
    print_bench("  GF(p^2) addition runs in ........................................ %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  GF(p^2) subtraction runs in ..................................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  GF(p^2) multiplication runs in .................................. %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  GF(p^2) squaring runs in ........................................ %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  GF(p^2) inversion (exponentiation) runs in ...................... %7lld ", cycles/SMALL_BENCH_LOOPS); print_unit;
    print_test("\n");
...
bool ecisog_run()
{
    ...
    print_bench("  Point doubling runs in .......................................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  4-isogeny of projective point runs in ........................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  4-isogeny evaluation at projective point runs in ................ %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  Point tripling runs in .......................................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  3-isogeny of projective point runs in ........................... %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
    ...
    print_bench("  3-isogeny evaluation at projective point runs in ................ %7lld ", cycles/BENCH_LOOPS); print_unit;
    print_test("\n");
