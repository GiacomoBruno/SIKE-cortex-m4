...
{ // Tests for the field arithmetic
    ...
    print_test("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    print_test("Testing field arithmetic over GF(p610): \n\n"); 
...
{ // Tests for the quadratic extension field arithmetic
    ...
    print_test("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    print_test("Testing quadratic extension arithmetic over GF(p610^2): \n\n"); 
...
bool fp_run()
{
    ...
    print_test("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    print_test("Benchmarking field arithmetic over GF(p610): \n\n"); 
...
bool fp2_run()
{
    ...
    print_test("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    print_test("Benchmarking quadratic extension arithmetic over GF(p610^2): \n\n"); 
